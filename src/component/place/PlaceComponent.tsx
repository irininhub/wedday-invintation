    ...
    return (
        <div className={s.placeComponent}>
            <div className={s.placeContainer}>
                ...
                <p className={s.placeText}>
                    Местом проведения нашего дня мы выбрали{" "}
                    <a
                        target="_blank"
                        style={{ color: "#5979bd" }}
                        href="https://www.instagram.com/usadbaganka/"
                    >
                        усадьбу Ганка
                    </a>
                    . Усадьба расположена в одном из живописных мест
                    Воложинского района на берегу небольшого озера на хуторе.
                </p>
                <p className={s.placeText}>
                ...
                <p className={s.placeTextSmall}>
                    Мы заберем гостей из двух точек. Первая Минск (Каменная
                    горка), а также деревня Острошицы. Трансфер привезет Вас в
                    усадьбу к началу торжества и завезет обратно, по указанным
                    адресам после окончания праздника
                </p>
            </div>
        </div>
    );
