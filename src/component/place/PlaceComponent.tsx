    ...
    return (
        <div className={s.placeComponent}>
            <div className={s.placeContainer}>
                ...
                <p className={s.placeText}>
                    Местом проведения нашего дня мы выбрали <a style={{ color: "#5979bd" }} href="https://www.instagram.com/usadbaganka/">усадьбу Ганка</a>. Усадьба расположена в одном из живописных мест Воложинского района на берегу
                ...
                <p className={s.placeTextSmall}>
                    ...
                    торжества и завезет обратно, по указанным адресам после окончания праздника
                </p>
            </div>
        </div>
    );
